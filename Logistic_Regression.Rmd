...
#2.5 confidence interval for bootstraps
logci_B3<-boot.ci(logBoot,conf=0.95, type="bca")

boot.ci(logBoot, type="bca",index = 1)
library(broom)
boot_Test <-tidy(logBoot,conf.int=TRUE,conf.method="bca")
test<-read_csv("~/Downloads/ci_boot_results")
...
CI.Results_B3
write_csv(CI.Results_B3, "~/Downloads/CI.Results_B3")
