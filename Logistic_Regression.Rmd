...
PHC_Reg<-glm(Ex_rec~
             ...
             TOTAL_TRAUMAS + BMI +
             #Health Conditions
             Arthritis + Athsma + Cancer + Chron_pain + Diabetes + Hrt_atk + 
             Hrt_dis + High_chol + High_bld_press + Kid_dis + Liv_dis +
             Migrane + MS + Osteoporosis + Rhum_arth + Stroke,
             # Data
             data =thesis_NHRVS,
...
PHC_Reg_df <-  data.frame(cbind(
  ...
  Wald = round(wald,2),
  OR = OR_PHC_Reg[8:length(OR_PHC_Reg)],
